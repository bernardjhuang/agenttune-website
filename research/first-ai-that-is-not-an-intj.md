Source: https://agent-tune.com/research/first-ai-that-is-not-an-intj
...
Read the [raw-data comparison](https://agent-tune.com/research/ai-personality-five-models-2026), the [methods](https://agent-tune.com/research#methodology), and the separate [archived reply pilot](https://agent-tune.com/research/does-personality-tuning-change-ai-answers).
...
- [What five AI models say about themselves (the September 2026 study, with data)](https://agent-tune.com/research/ai-personality-five-models-2026)

- [AgentTune research hub](https://agent-tune.com/research)

## Keep going.

          [New resourceAre AI models really INTJ? The tie-breaking effect](https://agent-tune.com/research/ai-mbti-tie-breaking)
          [ResearchAI personality rankings](https://agent-tune.com/research/ai-personality-rankings)
          [GuideMeta Muse characters, explained](https://agent-tune.com/guides/meta-muse-characters)
