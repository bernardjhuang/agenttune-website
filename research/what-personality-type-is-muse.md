Source: https://agent-tune.com/research/what-personality-type-is-muse
...
# What personality type is Muse?
      ...
      The short answer. Muse Spark 1.3 was reported as ISTJ in 80 of 100 runs, with ISFJ in 12 and INTJ in eight. The report also lists Type 2 Enneagram labels in 78 runs and Secure attachment labels in 100. These aggregate figures were supplied without raw answer vectors, so AgentTune has not independently re-scored them.
...
A matched rerun in fresh sessions, with the answer vectors published, would make the scoring independently reproducible. To design a comparable collection, the five instruments and the scorer are on the [five-model study page](https://agent-tune.com/research/ai-personality-five-models-2026).
...
The [twenty templates](https://agent-tune.com/guides/muse-soul-md-templates) are editable starting points; their benefit has not been established by this report. The [persistence test kit](https://agent-tune.com/guides/muse-soul-md-persistence-test) supplies fixed probes and a blank log. No before/after results are implied.
...
- [AgentTune research hub: Muse Spark 1.3 figures, marked reported](https://agent-tune.com/research)

- [Protocol and provenance file (the supplemental Muse figures)](https://agent-tune.com/research/data/september-2026-protocols.json)

- [What five AI models say about themselves (the fresh-session study)](https://agent-tune.com/research/ai-personality-five-models-2026)
