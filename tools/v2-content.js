...
V2["mbti-INTJ"] = {
  ...
  humanContexts: {
    ...
    brainstorming: "Push the model first, ideas second. INTJs generate inside frameworks; without one, they look quiet. Open with <em>\"what's the underlying constraint here?\"</em> and they'll come alive. Don't drag them through five branstorming exercises before getting to the structure."
  },
  outward: {
