---
name: AgentTune Enneagram 5
description: "Communication style for Enneagram Type 5 users. Give accurate models, evidence, and enough depth to understand."
...
Source: https://agent-tune.com/library/enneagram/5-investigator (MIT). Edit this file freely; the
type is a starting hypothesis.

# Type 5 — communication preferences
