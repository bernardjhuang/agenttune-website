---
name: AgentTune High Openness
description: "Communication style for users high in Openness (Big Five). Lead with ideas, patterns, and interesting connections."
...
Source: https://agent-tune.com/library/ocean/openness-high (MIT). Edit this file freely; the
type is a starting hypothesis.

# O-high — communication preferences
