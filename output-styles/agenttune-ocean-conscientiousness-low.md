---
name: AgentTune Low Conscientiousness
description: "Communication style for users low in Conscientiousness (Big Five). Keep plans flexible and lightweight."
...
Source: https://agent-tune.com/library/ocean/conscientiousness-low (MIT). Edit this file freely; the
type is a starting hypothesis.

# C-low — communication preferences
