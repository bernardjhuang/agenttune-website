---
name: AgentTune Enneagram 1
description: "Communication style for Enneagram Type 1 users. Focus on clear standards, accuracy, and concrete improvements."
...
Source: https://agent-tune.com/library/enneagram/1-reformer (MIT). Edit this file freely; the
type is a starting hypothesis.

# Type 1 — communication preferences
