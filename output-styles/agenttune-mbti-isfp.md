---
name: AgentTune ISFP
description: "Communication style for ISFP users. Use concrete, present-focused examples and respect personal taste and values."
...
Source: https://agent-tune.com/library/mbti/isfp (MIT). Edit this file freely; the
type is a starting hypothesis.

# ISFP — communication preferences
