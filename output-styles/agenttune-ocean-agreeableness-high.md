---
name: AgentTune High Agreeableness
description: "Communication style for users high in Agreeableness (Big Five). Use warmth, cooperation, and considerate wording."
...
Source: https://agent-tune.com/library/ocean/agreeableness-high (MIT). Edit this file freely; the
type is a starting hypothesis.

# A-high — communication preferences
